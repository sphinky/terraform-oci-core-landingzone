...
module "lz_dynamic_groups" {
  ...
  dynamic_groups_configuration = var.extend_landing_zone_to_new_region == false && var.identity_domain_option != "Use Custom Identity Domain" ? (local.custom_dynamic_groups_configuration != null ? local.custom_dynamic_groups_configuration : local.dynamic_groups_configuration) : local.empty_dynamic_groups_configuration
}
...
locals {
  ...
  dynamic_groups_configuration = {
    dynamic_groups : merge(local.security_functions_dynamic_group, local.database_kms_dynamic_group, local.net_fw_app_dynamic_group)
  }

  custom_domain_dynamic_groups_configuration = {
    dynamic_groups : merge(local.custom_domain_security_functions_dynamic_group, local.custom_domain_database_kms_dynamic_group, local.custom_domain_net_fw_app_dynamic_group)
  }
