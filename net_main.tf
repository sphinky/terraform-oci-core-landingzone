  ...
  lz_network_configuration = {
    ...
    network_configuration_categories = {
      "${var.service_label}-network" = {
        vcns                      = merge(local.tt_vcn_4, local.tt_vcn_1, local.tt_vcn_2, local.tt_vcn_3, local.exa_vcn_1, local.exa_vcn_2, local.exa_vcn_3, local.oke_vcn_1, local.oke_vcn_2, local.oke_vcn_3, local.hub_vcn)
...
module "lz_network" {
  ...
  depends_on            = [ module.lz_zpr , module.ej_env_tag_namespace]
